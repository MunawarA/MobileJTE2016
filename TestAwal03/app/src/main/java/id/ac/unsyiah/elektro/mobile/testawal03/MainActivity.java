package id.ac.unsyiah.elektro.mobile.testawal03;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickButton (View view){
        ...
        Button btnY1 = (Button) findViewById(R.id.btnY1);
        Button btnY2 = (Button) findViewById(R.id.btnY2);
        Button btnZ1 = (Button) findViewById(R.id.btnZ1);
        Button btnZ2 = (Button) findViewById(R.id.btnZ2);
