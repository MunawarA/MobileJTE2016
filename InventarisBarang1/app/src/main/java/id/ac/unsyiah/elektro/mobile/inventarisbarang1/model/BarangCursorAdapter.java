package id.ac.unsyiah.elektro.mobile.inventarisbarang1.model;
...
import id.ac.unsyiah.elektro.mobile.inventarisbarang1.R;
...
public class BarangCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor){
        ...
        int [] gambar = {R.drawable.unavalaible,R.drawable.sakura,R.drawable.sarimi,R.drawable.sedap};
